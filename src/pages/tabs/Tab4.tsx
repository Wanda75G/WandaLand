...
const Tab4: React.FC = () => {
  ...
  const officeLocation = { lat: 31.600272723579522, lng: -106.4069455764382 };
      ...
      <IonContent>
        ...
        <IonCard className="dark-card">
          <IonCardHeader>
            ...
            <IonCardSubtitle>Agua locas para ti</IonCardSubtitle>
          </IonCardHeader>
          <IonCardContent>
            Somos una plataforma lider en ofrecer las mejores aguas frescas de la region, con una amplia variedad de sabores y opciones para satisfacer todos los gustos. Nuestro compromiso es brindar productos de alta calidad, frescura y un servicio excepcional a nuestros clientes. En WandaLand, nos apasiona crear experiencias refrescantes y deliciosas que alegren tu día.
          </IonCardContent>
        </IonCard>
        ...
        <IonList inset={true} className="dark-list">
          ...
          <IonItem lines="full">
            ...
            <IonLabel>
              ...
              <p>nonoscontactes@wandaland.com</p>
            </IonLabel>
          </IonItem>
          <IonItem lines="none">
